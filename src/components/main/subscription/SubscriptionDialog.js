...
import { Dialog, useMediaQuery, Grid, Box, Divider } from "@mui/material";
...
function SubscriptionDialog(props) {
  const { open, handleClose, getSubData, subData, selectedId } = props;
    ...
    >
      <Box p={4}>
        <Grid container spacing={3}>
          <Grid item xs={12}>
            <StyledText textAlign="center" fontSize="25px" fontWeight="bold">
              서브스크립션 정보
            </StyledText>
          </Grid>
          <Grid item xs={12}>
          ...
          <Grid item xs={12}>
            ...
            <ReactFormDatePicker name="endDate" disabled control={control} setValue={setValue} handleBlur={handleBlur} getValues={getValues} />
          </Grid>
          <Grid item xs={12}>
            <Box mb={1}>
          ...
          <Grid item xs={12}>
            <Grid container justifyContent="center" spacing={2}>
              <Grid item>
                <StyledButton background="#ff005b" hoverBackground="#e00452" height="36px" fontSize="16px" padding="0 20px" onClick={handleClose}>
                  취소
                </StyledButton>
              </Grid>
              <Grid item>
                <StyledButton height="36px" fontSize="16px" padding="0 20px" onClick={handleSubmit(onSubmit)}>
                  수정
                </StyledButton>
              </Grid>
            </Grid>
