        ...
        <TableBody>
          {subscribeData.map((item) => (
            <StyledTableRow key={item.id}>
              ...
              <StyledTableCell align="center">{item.advertiserName}</StyledTableCell>
              <StyledTableCell align="center">{item.advertiserEmail}</StyledTableCell>
              <StyledTableCell align="center">{item.advertiserTel}</StyledTableCell>
              <StyledTableCell align="center">{item.planName}</StyledTableCell>
              <StyledTableCell align="center">{item.planPriceMonth}</StyledTableCell>
              <StyledTableCell align="center">
                <StyledText textAlign="center" color={item.coupon ? Colors.green : Colors.red}>
                  {item.coupon ? "사용" : "미사용"}
                </StyledText>
              </StyledTableCell>
              <StyledTableCell align="center">{item.startDate || "-"}</StyledTableCell>
              <StyledTableCell align="center">{item.finishDate || "-"}</StyledTableCell>
              <StyledTableCell align="center">
