...
function PostPart(props) {
  ...
  function getGoogleVisionData() {
    ...
    axios
      .get("/TB_INSTA/getGoogleDataCommon", {
        params: { INS_ID, host },
      })
      .then((res) => {
  ...
  function getChartData() {
    setProcess(true);
    axios
      .get("/TB_INSTA/getGoogleDataApex", {
        params: { INS_ID },
      })
      .then((res) => {
        const { labelInfo, objectInfo } = res.data;
          ...
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <Box p="20px" pb="40px" bgcolor="#FFF" borderRadius="7px">
                ...
                <Typography variant="body1">{`일 평균 ${dayAvg}개 게시물을 업로드 합니다.`}</Typography>
              </Box>
            </Grid>
            <Grid item xs={6}>
              <Box p="20px" pb="40px" bgcolor="#FFF" borderRadius="7px">
                ...
                <Typography variant="body1">{`주 평균 ${weekAvg}개 게시물을 업로드 합니다.`}</Typography>
              </Box>
            </Grid>
          </Grid>
        </Grid>
