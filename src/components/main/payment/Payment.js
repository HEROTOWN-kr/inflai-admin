        ...
        <TableBody>
          {payments.map((item) => (
            <StyledTableRow key={item.PAY_ID}>
              ...
              <StyledTableCell align="center">{item.ADV_NAME}</StyledTableCell>
              <StyledTableCell align="center">{item.ADV_EMAIL}</StyledTableCell>
              <StyledTableCell align="center">{item.ADV_TEL}</StyledTableCell>
              <StyledTableCell align="center">{item.PAY_AMOUNT}</StyledTableCell>
              <StyledTableCell align="center">{item.PAY_DT}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
